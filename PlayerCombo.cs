...
public class PlayerCombo : NomaBehaviour
{
    ...
    //プレイヤーの現在の攻撃力
    private int _currentPlayerAttackPower;

    //プレイヤーの現在のコンボ
    private int _currentPlayerCombo = 0;

    //現在のコンボ猶予時間
    private float _currentComboGraceTime;

    //コンボテキスト
    [SerializeField,Header("コンボテキスト")]
    private Text _comboText = default;
    ...
    /// <summary>
    /// コンボの諸々の処理。UpdateまたはFixedUpdateで呼んでください。
    /// </summary>
    private void Combo()
    {
        //攻撃が当たったら
